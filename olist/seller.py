...
class Seller:
    ...
    def get_review_score(self):
        ...
        # Rename columns
        df.columns = [
            'seller_id', 'share_of_one_stars', 'share_of_five_stars','share_of_four_stars','share_of_three_stars','share_of_two_stars',
            'review_score'
        ]
    ...
    def get_training_data(self):
        ...
        """
        df_get_seller_features=self.get_seller_features()
        df_get_seller_delay_wait_time=self.get_seller_delay_wait_time()
        df_get_active_dates=self.get_active_dates()
        df_get_review_score= self.get_review_score()
        df_get_quantity=self.get_quantity()
        df_get_sales=self.get_sales()

        df_training_data=df_get_seller_features.merge(df_get_seller_delay_wait_time,how='inner',on='seller_id')
        df_training_data=df_training_data.merge(df_get_active_dates,how='inner',on='seller_id')
